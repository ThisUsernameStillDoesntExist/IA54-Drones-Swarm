...
public class DroneAIprops {
	...
	public double batteryBeginChargeRelativeThreshold=0.9;//under this threshold, the drone will search for a dockstation
	public double batteryEndChargeRelativeThreshold=0.95;//above this threshold, the drone will disconnect from a dockstation
